...
p1= patch(isosurface(fval, 245), 'FaceColor', 'red', ...
    'EdgeColor', 'none');
alpha(p1, trans/2);
p2= patch(isosurface(fval, 250), 'FaceColor', 'yellow', ...
    'EdgeColor', 'none');
alpha(p2, trans/4);
p3= patch(isosurface(fval, 255), 'FaceColor', 'green', ...
    'EdgeColor', 'none');
alpha(p3, trans/6);
p4= patch(isosurface(fval, 260), 'FaceColor', 'cyan', ...
    'EdgeColor', 'none');
alpha(p4, trans/8);
p5= patch(isosurface(fval, 265), 'FaceColor', 'blue', ...
    'EdgeColor', 'none');
alpha(p5, trans/10);
...
zlabel('Muscle Amplitude (AU$\times10^3$)', 'Interpreter', 'LaTeX', ...
    'FontSize', ftSize + 2, 'FontWeight', 'bold');
title('Hoot Isosurfaces', 'Interpreter', 'LaTeX', ...
