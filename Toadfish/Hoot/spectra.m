...
title('Generated Hoot Waveform', ...
    'Interpreter', 'LaTeX', 'FontSize', ftSize+2);

[Pxx, W]= pwelch(y, [], [], [], Fs);
Pxx= 20*log10(Pxx);
[yFish, FsFish, PxxFish, WFish]= psde(...
    'bw.7.27-1.22-1.23.08(filtered2)-singlehoot.wav');
...
title('Generated Hoot Welch Power Spectral Density Estimate', ...
    'Interpreter', 'LaTeX', 'FontSize', ftSize+2);
...
title('Generated Hoot Spectrogram', ...
    'Interpreter', 'LaTeX', 'FontSize', ftSize+2);
...
audiowrite('generated_hoot.wav', y_normalized, Fs);
...
function [ y, Fs, Pxx, W ] = psde( fname )
